...
import { INeobit } from "neobit"

const fs = require('fs/promises')

async function apiBuilder(
  { dataType, data, filePath, prefix = "/" }: { data: {}, dataType: "object" | "json" | "csv", filePath: string, prefix: string }) {
  let neo = this
  ...
  async function saveData(foo: any) {
